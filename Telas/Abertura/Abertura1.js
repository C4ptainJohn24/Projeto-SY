    ...
    return (
        <View style={styles.container}>
            ...
            <Animatable.View animation="fadeInLeft" style={styles.TitleContainer}>
                <Text style={styles.title}>Irrigação e manutenção de horta {'\n'}de maneira jamais vista</Text>
                <Text></Text>
            </Animatable.View>
            <View>
                <Animatable.View animation="fadeInLeft" style={styles.TextContainer}>
                    <Text style={styles.text}>Seu desejo é economizar água e facilitar a {'\n'}irrigação de sua horta? {'\n'}Existe apenas um escolha...</Text>
                </Animatable.View>
            </View>
